...
public class GetModeConstants {
    public static final String WELCOME = "\nHello! This is Cryptanalyzer v.1.0 by Nazaroff_DevTeam©.\nPlease select mode:\n";
    public static final String MODE_SELECT_1 = "1. Encrypt";
    public static final String MODE_SELECT_2 = "2. Decrypt";
