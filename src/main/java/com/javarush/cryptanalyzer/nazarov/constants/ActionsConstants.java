...
public class ActionsConstants {
    ...
    public static final String ENCODER_ERROR = "Encoder finished with error";
    public static final String FILE_DECODED = "The file was decoded successfully";
    public static final String DECODER_ERROR = "Decoder finished with error";
    public static final String BRUTEFORCE_FINISHED = "Bruteforce analysis finished";
